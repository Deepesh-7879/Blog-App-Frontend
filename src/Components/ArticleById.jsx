  ...
  useEffect(() => {
    ...
    const getArticle = async () => {
      ...
      try {
        ...
        const res = await axios.get(`https://blog-app-backend-1-9pqo.onrender.com/${roleApi}/articles/${id}`, { withCredentials: true });
  ...
  const toggleArticleStatus = async () => {
    ...
    try {
      const res = await axios.patch(
        `https://blog-app-backend-1-9pqo.onrender.com/author-api/articles/${id}/status`,
