  ...
  const userRegister = async (newUser) => {
    ...
    try {
      ...
      if (selectedFile) {
        ...
        resObj = await axios.post(`https://blog-app-backend-1-9pqo.onrender.com/${roleLower}-api/users`, formData);
      } else {
        ...
        resObj = await axios.post(`https://blog-app-backend-1-9pqo.onrender.com/${roleLower}-api/users`, jsonData, {
